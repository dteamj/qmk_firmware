 ...
 * | ESC  |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   -  |   =  |   '  |  ]   |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | DEL  |  VI  | / CTRL  /       \ SHFT \  | DWN  |BackSP| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_ESC,      KC_Z,      KC_X,       KC_C,       KC_V,       KC_B,    XXXXXXX,     XXXXXXX,     KC_N,       KC_M,       KC_MINS,    KC_EQL,     KC_QUOT,    K_BRC,   
                     KC_LALT,    KC_DEL,    MO_VI,    KC_LCTL,                                KC_LSFT,    MO_DWN,    KC_BSPC,    KC_RGUI
),
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |  C-Z | C-X  | C-C  | C-V  | A-V  |                    | C-DOT| A-DOT|      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | A-TAB|      |  ALT | SHFT | CTRL |  C-/ |-------.    ,-------| Left | Down |  Up  |Right |  Tab | ENT  |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |  C-Z | C-X  | C-C  | C-V  | A-V  |-------|    |-------| BSP  |  DEL |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_VI] = LAYOUT(
  ...
  XXXXXXX,    C(KC_Z),    C(KC_X),    C(KC_C),    C(KC_V),    A(KC_V),                        XXXXXXX,    C(KC_DOT),  A(KC_DOT),  XXXXXXX,    XXXXXXX,    XXXXXXX,   
  A(KC_TAB),  XXXXXXX,    KC_LALT,   	KC_LSFT,   	KC_LCTL,   	C(KC_SLSH),                    	KC_LEFT,    KC_DOWN,   	KC_UP,      KC_RGHT,   	KC_TAB,   	_______,   
  XXXXXXX,	  C(KC_Z),   	C(KC_X),   	C(KC_C),   	C(KC_V),    A(KC_V),   XXXXXXX,    XXXXXXX, KC_BSPC,   	KC_DEL,    XXXXXXX,     XXXXXXX,    XXXXXXX,    XXXXXXX,   
